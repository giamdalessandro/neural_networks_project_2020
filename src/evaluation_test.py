...
tree100.info()
tree007 = from_json(InterpretableTree(), TREE007)
tree007.info()
...
for img in os.listdir(POS_IMAGE_SET_TEST):
    ...
    y_tree100_7.append(1 if tree100.predict(test_image, fc_model, flat_output, level=7) > 0.5 else 0)
...
print("accuracy_score TREE layer 7 ", (accuracy_score(y_true, y_tree100_7)*100))
